...
--Telescope-change-x
map("n", "<localleader>cw", function() require("rnvim.configs.telescope").change_wallpaper() end, { desc = "Change wallpaper" })
map("n", "<localleader>cc", function() require("rnvim.configs.telescope").change_colourscheme() end,
...
map("n", "tb", function() require("rnvim.colourscheme").clear() end, { desc = "Transparent Background" })
map("n", "qZ", "Z")
