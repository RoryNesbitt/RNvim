...
vim.g.closetag_filenames = '*.html,*.xhtml,*.phtml,*.php,*.js,*.jsx,*.tsx'
...
vim.g.closetag_regions = "{ 'typescript.tsx': 'jsxRegion,tsxRegion', 'typescriptreact': 'jsxRegion,tsxRegion', 'javascriptreact': 'jsxRegion', }"
